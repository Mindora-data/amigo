...
- Arranque persistente del servidor sin depender de una terminal abierta. Hecho inicial: `scripts/nino-launchd`.
...
- Arranque automatico macOS. Hecho inicial: `scripts/nino-launchd install`.
